...
namespace IIS.Avtomatizaciya_zakupok2
{
    ...
    public class ТЧЗаказ : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Avtomatizaciya_zakupok2.Номенклатура fНоменклатура;
        
        private IIS.Avtomatizaciya_zakupok2.ЗаказПост fЗаказПост;
        ...
        [PropertyStorage(new string[] {
                "Номенклатура"})]
        [NotNull()]
        public virtual IIS.Avtomatizaciya_zakupok2.Номенклатура Номенклатура
        {
            get
            {
                ...
                IIS.Avtomatizaciya_zakupok2.Номенклатура result = this.fНоменклатура;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.Avtomatizaciya_zakupok2.ЗаказПост.
        /// </summary>
        ...
        [PropertyStorage(new string[] {
                "ЗаказПост"})]
        public virtual IIS.Avtomatizaciya_zakupok2.ЗаказПост ЗаказПост
        {
            get
            {
                ...
                IIS.Avtomatizaciya_zakupok2.ЗаказПост result = this.fЗаказПост;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ТЧЗаказE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ТЧЗаказE", typeof(IIS.Avtomatizaciya_zakupok2.ТЧЗаказ));
                }
            }
        }
    }
    ...
    public class DetailArrayOfТЧЗаказ : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.Avtomatizaciya_zakupok2.DetailArrayOfТЧЗаказ members)

        // *** End programmer edit section *** (IIS.Avtomatizaciya_zakupok2.DetailArrayOfТЧЗаказ members)
        ...
        /// </summary>
        public DetailArrayOfТЧЗаказ(IIS.Avtomatizaciya_zakupok2.ЗаказПост fЗаказПост) : 
                base(typeof(ТЧЗаказ), ((ICSSoft.STORMNET.DataObject)(fЗаказПост)))
        {
        }
        
        public IIS.Avtomatizaciya_zakupok2.ТЧЗаказ this[int index]
        {
            get
            {
                return ((IIS.Avtomatizaciya_zakupok2.ТЧЗаказ)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.Avtomatizaciya_zakupok2.ТЧЗаказ dataobject)
        {
