...
namespace IIS.Avtomatizaciya_zakupok2
{
    ...
    public class План : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Avtomatizaciya_zakupok2.ПланЗакупок fПланЗакупок;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.Avtomatizaciya_zakupok2.ПланЗакупок.
        /// </summary>
        ...
        [PropertyStorage(new string[] {
                "ПланЗакупок"})]
        public virtual IIS.Avtomatizaciya_zakupok2.ПланЗакупок ПланЗакупок
        {
            get
            {
                ...
                IIS.Avtomatizaciya_zakupok2.ПланЗакупок result = this.fПланЗакупок;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ПланE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПланE", typeof(IIS.Avtomatizaciya_zakupok2.План));
                }
            }
        }
    }
    ...
    public class DetailArrayOfПлан : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.Avtomatizaciya_zakupok2.DetailArrayOfПлан members)

        // *** End programmer edit section *** (IIS.Avtomatizaciya_zakupok2.DetailArrayOfПлан members)
        ...
        /// </summary>
        public DetailArrayOfПлан(IIS.Avtomatizaciya_zakupok2.ПланЗакупок fПланЗакупок) : 
                base(typeof(План), ((ICSSoft.STORMNET.DataObject)(fПланЗакупок)))
        {
        }
        
        public IIS.Avtomatizaciya_zakupok2.План this[int index]
        {
            get
            {
                return ((IIS.Avtomatizaciya_zakupok2.План)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.Avtomatizaciya_zakupok2.План dataobject)
        {
