    ...
    public class ЕдиницыИзмер : ICSSoft.STORMNET.DataObject
    {
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ЕдиницыИзмерE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ЕдиницыИзмерE", typeof(IIS.Avtomatizaciya_zakupok2.ЕдиницыИзмер));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ЕдиницыИзмерL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ЕдиницыИзмерL", typeof(IIS.Avtomatizaciya_zakupok2.ЕдиницыИзмер));
                }
            }
        }
    }
