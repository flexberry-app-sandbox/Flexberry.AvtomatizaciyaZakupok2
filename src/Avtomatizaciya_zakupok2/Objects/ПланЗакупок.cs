...
namespace IIS.Avtomatizaciya_zakupok2
{
    ...
    public class ПланЗакупок : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Avtomatizaciya_zakupok2.DetailArrayOfПлан fплан;
        ...
        public virtual IIS.Avtomatizaciya_zakupok2.DetailArrayOfПлан план
        {
            get
            {
                ...
                if ((this.fплан == null))
                {
                    this.fплан = new IIS.Avtomatizaciya_zakupok2.DetailArrayOfПлан(this);
                }
                IIS.Avtomatizaciya_zakupok2.DetailArrayOfПлан result = this.fплан;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ПланЗакупокE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПланЗакупокE", typeof(IIS.Avtomatizaciya_zakupok2.ПланЗакупок));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ПланЗакупокL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПланЗакупокL", typeof(IIS.Avtomatizaciya_zakupok2.ПланЗакупок));
                }
            }
        }
    }
