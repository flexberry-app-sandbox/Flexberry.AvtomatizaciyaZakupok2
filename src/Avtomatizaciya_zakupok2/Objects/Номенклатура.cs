...
namespace IIS.Avtomatizaciya_zakupok2
{
    ...
    [View("НоменклатураE", new string[] {
            ...
            "ЕдиницыИзмер.ЕдиницаИзмер as \'Единица измерения\'"}, Hidden=new string[] {
    ...
    public class Номенклатура : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Avtomatizaciya_zakupok2.ЕдиницыИзмер fЕдиницыИзмер;
        ...
        [PropertyStorage(new string[] {
                "ЕдиницыИзмер"})]
        [NotNull()]
        public virtual IIS.Avtomatizaciya_zakupok2.ЕдиницыИзмер ЕдиницыИзмер
        {
            get
            {
                ...
                IIS.Avtomatizaciya_zakupok2.ЕдиницыИзмер result = this.fЕдиницыИзмер;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View НоменклатураE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("НоменклатураE", typeof(IIS.Avtomatizaciya_zakupok2.Номенклатура));
                }
            }
            ...
            public static ICSSoft.STORMNET.View НоменклатураL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("НоменклатураL", typeof(IIS.Avtomatizaciya_zakupok2.Номенклатура));
                }
            }
        }
    }
