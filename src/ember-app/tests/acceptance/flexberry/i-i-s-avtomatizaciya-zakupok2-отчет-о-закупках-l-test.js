...
moduleForAcceptance('[AGAT] Acceptance | i i s avtomatizaciya zakupok2 отчет о закупках l');

test('testing i-i-s-avtomatizaciya-zakupok2-отчет-о-закупках-l', function(assert) {
