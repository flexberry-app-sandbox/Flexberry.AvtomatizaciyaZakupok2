...
moduleForAcceptance('[AGAT] Acceptance | i i s avtomatizaciya zakupok2 единицы измер l');

test('testing i-i-s-avtomatizaciya-zakupok2-единицы-измер-l', function(assert) {
