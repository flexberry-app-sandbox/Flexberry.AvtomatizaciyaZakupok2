...
moduleForAcceptance('[AGAT] Acceptance | i i s avtomatizaciya zakupok2 номенклатура l');

test('testing i-i-s-avtomatizaciya-zakupok2-номенклатура-l', function(assert) {
