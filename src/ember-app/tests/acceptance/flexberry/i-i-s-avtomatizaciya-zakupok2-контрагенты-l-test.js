...
moduleForAcceptance('[AGAT] Acceptance | i i s avtomatizaciya zakupok2 контрагенты l');

test('testing i-i-s-avtomatizaciya-zakupok2-контрагенты-l', function(assert) {
