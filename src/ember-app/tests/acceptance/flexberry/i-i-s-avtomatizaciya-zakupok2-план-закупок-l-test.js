...
moduleForAcceptance('[AGAT] Acceptance | i i s avtomatizaciya zakupok2 план закупок l');

test('testing i-i-s-avtomatizaciya-zakupok2-план-закупок-l', function(assert) {
