...
moduleForModel('i-i-s-avtomatizaciya-zakupok2-склады', 'Unit | Serializer | i-i-s-avtomatizaciya-zakupok2-склады', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-avtomatizaciya-zakupok2-склады',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
