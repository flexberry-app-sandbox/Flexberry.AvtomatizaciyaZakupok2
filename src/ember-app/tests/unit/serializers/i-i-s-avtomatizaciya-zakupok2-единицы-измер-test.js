...
moduleForModel('i-i-s-avtomatizaciya-zakupok2-единицы-измер', 'Unit | Serializer | i-i-s-avtomatizaciya-zakupok2-единицы-измер', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-avtomatizaciya-zakupok2-единицы-измер',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
