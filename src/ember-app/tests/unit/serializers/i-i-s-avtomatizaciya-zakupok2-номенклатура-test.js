...
moduleForModel('i-i-s-avtomatizaciya-zakupok2-номенклатура', 'Unit | Serializer | i-i-s-avtomatizaciya-zakupok2-номенклатура', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-avtomatizaciya-zakupok2-номенклатура',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
