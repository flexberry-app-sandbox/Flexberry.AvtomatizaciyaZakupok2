...
moduleForModel('i-i-s-avtomatizaciya-zakupok2-контрагенты', 'Unit | Serializer | i-i-s-avtomatizaciya-zakupok2-контрагенты', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-avtomatizaciya-zakupok2-контрагенты',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
