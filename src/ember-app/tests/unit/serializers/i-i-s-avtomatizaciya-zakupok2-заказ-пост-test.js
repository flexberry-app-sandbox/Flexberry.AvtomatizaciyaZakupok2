...
moduleForModel('i-i-s-avtomatizaciya-zakupok2-заказ-пост', 'Unit | Serializer | i-i-s-avtomatizaciya-zakupok2-заказ-пост', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-avtomatizaciya-zakupok2-заказ-пост',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
