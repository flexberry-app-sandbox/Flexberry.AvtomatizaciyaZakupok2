...
moduleForModel('i-i-s-avtomatizaciya-zakupok2-т-ч-заказ', 'Unit | Serializer | i-i-s-avtomatizaciya-zakupok2-т-ч-заказ', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-avtomatizaciya-zakupok2-т-ч-заказ',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
