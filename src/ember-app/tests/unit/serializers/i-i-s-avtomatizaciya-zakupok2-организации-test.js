...
moduleForModel('i-i-s-avtomatizaciya-zakupok2-организации', 'Unit | Serializer | i-i-s-avtomatizaciya-zakupok2-организации', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-avtomatizaciya-zakupok2-организации',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
