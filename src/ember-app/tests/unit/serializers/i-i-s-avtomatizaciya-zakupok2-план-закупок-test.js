...
moduleForModel('i-i-s-avtomatizaciya-zakupok2-план-закупок', 'Unit | Serializer | i-i-s-avtomatizaciya-zakupok2-план-закупок', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-avtomatizaciya-zakupok2-план-закупок',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
